...
class AllureHtmlParser(BaseParser):
    ...
    def parse(self, report_path: Path) -> TestRun:
        ...
        Returns:
            A fully populated :class:`~qalens.models.run.TestRun`.
    ...
    def _build_metadata(
        ...
        """Build :class:`~qalens.models.run.RunMetadata` from the summary widget.
        ...
        Returns:
            A populated :class:`~qalens.models.run.RunMetadata`.
        """
    ...
    def _extract_test_cases(
        ...
        Returns:
            List of :class:`~qalens.models.test_case.TestCaseResult` objects.
        """
    ...
    def _extract_single_test_case(
        ...
        :class:`~qalens.models.test_case.TestCaseResult`.
        ...
        Returns:
            A :class:`~qalens.models.test_case.TestCaseResult`, or ``None``
    ...
    def _extract_steps(
        ...
        Returns:
            Flat list of :class:`~qalens.models.test_case.StepResult` objects
    ...
    def _extract_failure(
        ...
        """Build a :class:`~qalens.models.failure.FailureInfo` from test-case data.
    ...
    def _extract_attachments(
        ...
        """Convert Allure attachment objects to :class:`~qalens.models.attachment.Attachment`.
    ...
    def _mime_to_kind(self, mime: str) -> AttachmentKind:
        """Map a MIME type string to an :class:`~qalens.models.attachment.AttachmentKind`.

        Args:
            mime: MIME type string (e.g. ``"image/png"``).

        Returns:
            The most appropriate :class:`~qalens.models.attachment.AttachmentKind`.
        """
        mime = (mime or "").lower()
