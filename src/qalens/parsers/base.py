...
class DetectionResult(BaseModel):
    ...
    :class:`DetectionResult`. The :class:`~qalens.parsers.detector.Detector`
...
class BaseParser(ABC):
    ...
    3. Implement :meth:`parse` to return a normalized :class:`~qalens.models.run.TestRun`.
    ...
    Warning collection:
        ...
        :class:`~qalens.models.warnings.ExtractionWarning` objects. These are
        attached to the returned :class:`~qalens.models.run.TestRun`.
    """
    ...
    def parse(self, report_path: Path) -> TestRun:
        ...
        - Return a :class:`~qalens.models.run.TestRun` even for partial results.
        ...
        Returns:
            A normalized :class:`~qalens.models.run.TestRun`.
    ...
    def _collect_warnings(self) -> list[ExtractionWarning]:
        ...
        extraction to attach warnings to the returned :class:`~qalens.models.run.TestRun`.
