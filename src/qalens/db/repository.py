...
from qalens.db.schema import get_connection, init_db
from qalens.db.models import RunRow, TestCaseRow, TestHistoryEntry  # noqa: F401
...
class RunRepository:
    ...
    def save_run(self, test_run: Any, *, skip_if_exists: bool = True) -> bool:
        """Persist a :class:`~qalens.models.run.TestRun` to the database.
        ...
        """
        from qalens.models.run import TestRun  # local import to avoid circular
    ...
    def save_artifacts(self, records: "list[Any]") -> None:
        """Bulk-insert :class:`~qalens.artifacts.models.ArtifactRecord` objects.
        ...
        Args:
            records: List of
                :class:`~qalens.artifacts.models.ArtifactRecord` dataclass
                instances produced by
                :class:`~qalens.artifacts.policy.ArtifactIngestionPolicy`.
        """
        if not records:
            return
        for rec in records:
        ...
        *,
        ...
        Args:
            canonical_name: The normalised test name (use
                :func:`~qalens.analyzers.canonical.to_canonical_name` first).
