"""Insight, cluster, and analysis summary models for QA Lens.

These models carry the output of the QA Lens analysis pipeline.
...
class InsightCategory(str, Enum):
    """The set of root-cause categories QA Lens can assign to a failure.
...
class Insight(BaseModel):
    ...
    categorizer. QA Lens never produces silent black-box verdicts.
    ...
    Attributes:
        ...
        confidence: A float in [0.0, 1.0] representing how confident QA Lens is
...
class AnalysisSummary(BaseModel):
    """The complete output of the QA Lens analysis pipeline for one test run.
    ...
    Attributes:
        ...
        analysis_engine_version: The QA Lens version that produced this summary.
    """
    ...
    analysis_engine_version: str = Field(
        default="",
        description="QA Lens version that produced this summary.",
    )
