...
``ArtifactRecord``
    Produced by :class:`~qalens.artifacts.policy.ArtifactIngestionPolicy`.
...
class ArtifactRecord:
    ...
    Produced by :meth:`~qalens.artifacts.policy.ArtifactIngestionPolicy.process`
    after applying the configured :class:`~qalens.artifacts.config.ArtifactMode`.
