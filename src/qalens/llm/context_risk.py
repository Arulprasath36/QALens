"""Risk-prediction context builder for QA Lens LLM queries.
...
def _has_slowing_chip(signals: "RiskSignals") -> bool:  # type: ignore[name-defined]
    ...
    """
    from qalens.analyzers.predictor import RiskSignals  # noqa: F821 – type guard
    sig_values = [
...
def gather_risk_context(
    *,
    ...
    """Build a context block driven by :class:`~qalens.analyzers.predictor.RiskPredictor`.
