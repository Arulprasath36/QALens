...
from qalens.llm.answer_types import AnswerIntent, AnswerScope, AnswerType
...
def generate_follow_ups(
    ...
    *,
    ...
    answer_plan_or_intent:
        An :class:`~qalens.llm.answer_plan.AnswerPlan` (preferred) or a bare
        :class:`~qalens.llm.answer_types.AnswerIntent` (backward-compatible).
