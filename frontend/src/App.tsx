        ...
        {collapsed ? (
          ...
          <div className="flex flex-col items-center gap-2 py-3 px-2 border-b border-slate-200 dark:border-slate-800">
            <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-xl">
              <img src={`${import.meta.env.BASE_URL}qalens-icon.png`}      alt="QA Lens" className="h-11 w-11 object-contain dark:hidden" />
              <img src={`${import.meta.env.BASE_URL}qalens-icon-dark.png`} alt="QA Lens" className="hidden h-11 w-11 object-contain dark:block" />
            </div>
            <button
            ...
            <Tooltip content="Export report" placement="right">
              <button
                ...
                className="group flex w-full items-center justify-center rounded-xl px-0 py-2.5
                           ...
                           dark:text-slate-400 dark:hover:bg-slate-800/70 dark:hover:text-white
                           transition-colors duration-150"
                aria-label="Export QA Lens report"
              >
  ...
  if (state.required && !state.authenticated) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-page px-4 text-primary">
        ...
        >
          <div className="mb-5">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">QA Lens admin access</p>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">
              This server requires a bearer token before QA Lens can read data or update settings.
            </p>
          </div>
          ...
          >
            {submitting ? 'Checking...' : 'Unlock QA Lens'}
          </button>
        </form>
      </div>
    );
